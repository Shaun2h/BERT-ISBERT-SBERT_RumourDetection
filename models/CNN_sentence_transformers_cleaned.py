...
class CNN(nn.Module):
    ...
    def forward(self, bert_output,raw_bert_input):
        ...
        sentence_lengths = torch.sum(raw_bert_input["attention_mask"], dim=1)
        outputdict["sentence_lengths"] = sentence_lengths
        outputdict["attention_mask"] = raw_bert_input["attention_mask"]
        outputdict["pooler_output"] = out
        outputdict["cls_token_embeddings"] = out[:,0]
        outputdict["token_embeddings"] = bert_output["last_hidden_state"]
